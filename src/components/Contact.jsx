...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Garance Vermorel",
          from_email: form.email,
          to_email: "garancevermorel66@gmail.com",
      ...
      .then(
        ...
        (error) => {
          ...
          alert("Ahh, il y'a eu une erreur. Veuillez recommenecez.");
        }
      );
  };
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Venez me parler</p>
